...
function formatSelectors (rule, indentation, stylelint) {
  ...
  if (stylelint['selector-list-comma-space-after'] && !stylelint['selector-list-comma-newline-after']) {
    separator += selectorListCommaSpaceAfter(stylelint, isSingleLine)
  }

  if (stylelint['selector-list-comma-newline-after']) {
  	var spacer = (stylelint['selector-list-comma-space-after'] === 'always') ? ' ' : ''
